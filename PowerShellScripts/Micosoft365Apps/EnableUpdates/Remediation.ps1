#Remediates systems with Office updates disabled
#
#
...
Try {
    ...
    If ($Registry32bit) {
        Remove-ItemProperty -Path $32bitPath -Name $Name -ErrorAction Stop -Force
        Write-Output "Compliant"
        Exit 0
    }
    If ($Registry64bit) {
        Remove-ItemProperty -Path $64bitPath -Name $Name -ErrorAction Stop -Force
        Write-Output "Compliant"
        Exit 0
    }
